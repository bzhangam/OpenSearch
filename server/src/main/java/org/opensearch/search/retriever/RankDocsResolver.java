 ...
 * place the {@code _id -> luceneDocId} translation lives, shared by {@code RankDocsQuery}'s scorer (to
 * attach the pre-computed score) and {@code RankDocsFieldComparatorSource} (to attach the position), so the
