 ...
 * {@code RankDocsQueryBuilder}; {@code RankDocsQueryBuilder#doToQuery} then scopes it to this shard's
 ...
 * handled separately by {@code RankDocsFieldComparatorSource}; this query only carries {@code _id}s and scores.
 * <p>
...
public final class RankDocsQuery extends Query {
     ...
     *                  {@code RankDocsQueryBuilder#doToQuery}); MUST already be immutable
